...
class DIFT_NET_G_DIFF_GLOBAL(nn.Module):
    def __init__(self,args,measurements_length,dift_code_len):
        ...
        self.dift_part = self.dift_part_f(input_size+32)
    ...
    def dift_part_f(self,input_size,name_prefix = "DIFTGDIFFGLOBAL_"):
        layer_stack = OrderedDict()
    ...
    def forward(self,batch_data,view_mat_model_t,view_mat_for_normal_t):
        ...
        x_n = torch.cat([x_n,view_mat_model_t,view_mat_for_normal_t],dim=1)
