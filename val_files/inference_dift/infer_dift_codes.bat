SET DATA_ROOT="D:/CVPR21_freshmeat/7_3_row/sphere/"
SET MODEL_ROOT="D:/CVPR21_models/7_3_row/models/"
SET MODEL_FILE_NAME="model_state_1800000.pkl"

SET SAMPLE_VIEW_NUM=24
SET ROTATE_VIEW_NUM=1
SET MEASUREMENT_LEN=4
SET DIFT_CODE_LEN=16
